...
`r emo::ji("pouting_face")` - `r emo::ji("slightly_frowning_face")` - `r emo::ji("neutral_face")` - `r emo::ji("slightly_smiling_face")` - `r emo::ji("star_struck")`  
...
![Tableau des nécroses 2023](`r necroses2023`)  

Voici quelques exemples de ce qui peut être observé sur le dispositif :  
Le <span style="color: red;">**Grenache témoin**</span> (traité) à gauche et le <span style="color: red;">**Grenache témoin non traité**</span> (à droite) pour lequel on constate une défoliation quasi totale.  
![Grenache témoin traité en 2023](`r Grenache_Témoin`) ![Grenache témoin non traité en 2023](`r Grenache_TNT`)  

Nécroses de résistance faciès **petits points noirs**  
![Petits points noirs](`r RR135_petits_points`)  

Nécroses de résistance faciès **gros points noirs**  
![Gros points noirs](`r RR109_gros_points`)  
  
Nécroses localisées de façon préférentielle le long des **nervures**  
![Nécroses le long des nervures](`r RR006_nervures`)  
  
Nécroses de résistance faciès **grosses taches brunes à liseré**  
![Grosses taches brunes à liseré](`r RR139_gros_point_lisere`)   

**Fructifications sèches** sur Muscaris   
![Fructifications sèches sur Muscaris](`r Muscaris_fructi_seches`)   
  
**Fructifications actives** sur un des génotypes, le <span style="color: #89BA21;">**RR091**</span>   
![Fructifications actives](`r RR091_mildiou_fructifications`)   

**Black-rot actif** sur jeunes feuilles  
![Black-rot actif sur jeunes feuilles](`r RR009_blackrot`)   
  
**Black-rot "bloqué"** sur jeunes feuilles, avec centre de la tache gris au lieu d'être brun avec des picnides
![Black-rot bloqué](`r BRbloque`)   
