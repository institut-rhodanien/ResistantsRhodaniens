...
Il présente les multiples résultats d'observation du dispositif des Résistants Rhodaniens **planté en 2019** présentés sous forme de **fiches individuelles pour chaque génotype**, avec les données des millésimes 2022, 2023 et 2024.
...
gt_maladies <- gt(sous_tablo_necrosesMM) %>%
  ...
  # tab_style(style = list ( cell_text(weight="bold", color="red", size=8)),
  #           locations = cells_body( columns = c(Avec_mildiou_actif) , rows= Avec_mildiou_actif=="Epsilon (<1%))"))%>%
  # tab_style(style = list ( cell_text(weight="bold", color="red", size=8)),
