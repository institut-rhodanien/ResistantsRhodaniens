---
title: |
  <center> Résistants Clairette de Die 2024  </center>
...
Ce document est une annexe au compte-rendu technique d'expérimentation des "Résistants Clairette de Die" pour l'année 2024.
Il présente les résultats d'observation du dispositif sous forme de **fiches individuelles pour chaque génotype**, avec les données des millésimes 2023, 2024.
...
RDie <- read_csv("Moda/vecteurRDie.csv",   col_names = FALSE)
vecteurRDie <- (RDie$X1 )
...
cat("\n") 
cat("Résumé **appréciation globale viticole** à l'approche de la récolte, millésimes 2023 - 2024:\n")
cat('<center><font size="6">',"2023 :", emoji2023, "2024 :", emoji2024, "</font></center>\n")
cat("\n","\n") 
